<div class="header ">
    ...
    <div class="">
        <div class="brand inline">
            <img src="{{ asset('themes/page/assets/img/logo.png') }}" alt="logo"
        ...
        <a href="#" class="btn btn-link text-primary m-l-20 d-none d-lg-inline-flex d-xl-inline-flex">Add
            New Item</a>
                                    ...
                                    <div class="heading">
                                        <div
                                            ...
                                            <img width="30" height="30"
                                                ...
                                                alt=""
                                                src="{{ asset('themes/page/assets/img/profiles/1.jpg') }}">
                                        </div>
        ...
        <div class="dropdown pull-right d-lg-block d-none">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <span class="thumbnail-wrapper d32 circular inline">
                    <img src="{{ get_image(auth()->user()->avata) }}" alt=""
                        data-src="{{ get_image(auth()->user()->avata) }}"
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                ...
                <a href="{{route('home.index')}}" class="dropdown-item">Your Profile</a>
                ...
                <div class="dropdown-divider"></div>
                <span class="dropdown-item fs-12 hint-text">Last edited by {{ Auth::user()->name }}<br />on Friday at
                    5:27PM</span>
            </div>
        </div>
        <!-- END User Info-->
        <a href="#" class="header-icon btn-icon-link m-l-10 sm-no-margin d-inline-block"
